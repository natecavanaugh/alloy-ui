		...
		groups: {
            alloy: {
                ...
                modules: {
						...
						'aui-swf-util': {skinnable:false, requires:['aui-base','querystring-stringify-simple']},
						...
						'aui-uploader': {skinnable:true, requires:['aui-base','aui-task-manager','stylesheet','uploader-deprecated']},
