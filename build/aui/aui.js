		...
		groups: {
            alloy: {
                ...
                modules: {
						...
						'aui-swf-util': {requires:['aui-base','querystring-stringify-simple'], skinnable:false},
						...
						'aui-uploader': {requires:['aui-base','aui-task-manager','stylesheet','uploader'], skinnable:true},
